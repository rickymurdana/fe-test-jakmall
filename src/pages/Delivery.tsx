...
const Delivery: React.FC = () => {
  ...
  const local: any = localStorage.getItem("data");
  let dataLocal: any;
  if (local) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    dataLocal = JSON.parse(local);
  }
  const {
    isEmail,
    validateEmail,
  ...
  const {
    ...
    defaultValues: {
      ...
      dropShipperName: dataLocal?.dropShipperName || "",
      dropshipperphone: dataLocal?.dropshipperphone || "",
      ...
      <section className="delivery">
        <section className="header">
          ...
          <div className="is-dropship">
            <input id="chk" onChange={() => setChecked(!checked)} type="checkbox" />
